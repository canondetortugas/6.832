...
for iter=1:max_iter
    ...
    % Baseline cost. Note that this will never have any terms due
    % to LQR because we will have exited before this point if the
    % LQR basin was reached.
    C = finalCost(xtraj);
    ...
    % Sample uniformly on the sampling interval centered at zero
